...
async function maybeOutage(
  ...
  // it completes. If the same phase also has a small outage, the outage
  // starts first so the kernel-side connection drop happens *during* the
  // JS suspension (matches "TCP keepalive expires while phone is asleep").
